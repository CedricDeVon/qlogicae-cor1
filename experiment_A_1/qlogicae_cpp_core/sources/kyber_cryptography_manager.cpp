	...
	QLOGICAE_COR_V1__BASE__HPP_CPP__COR_NAMESPACE_NAME
{
    KyberCryptographyManager
		::KyberCryptographyManager() :
			QLOGICAE_COR_V1__BASE__HPP_CPP__ABSTRACT_CLASS_NAME<KyberCryptographyManagerConfigurations>()
	{
			...
			)
	{
        ...
        {					
			...
			OQS_KEM* kem = OQS_KEM_new(
				QLOGICAE_COR_V1__BASE__HPP_CPP__GET_SINGLETON_TEMPLATE<KyberCryptographyAlgorithmEnumManager>()
