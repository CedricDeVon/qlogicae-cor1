...
#define QLOGICAE_COR_V1__BASE__HPP_CPP__ENUM_CONSTANTS \
	NONE \
...
#define QLOGICAE_COR_V1__BASE__HPP_CPP__MUTEX_LAYER_2 \
	2 \

#define QLOGICAE_COR_V1__BASE__HPP_CPP__MUTEX_LAYER_3 \
	3 \

#define QLOGICAE_COR_V1__BASE__HPP_CPP__MUTEX_LAYER_4 \
	4 \

#define QLOGICAE_COR_V1__BASE__HPP_CPP__EMPTY_EDGE_CASES \
	false \

#define QLOGICAE_COR_V1__BASE__HPP_CPP__IMPLICIT_RETURN_VALUE \
	{}; \

#define QLOGICAE_COR_V1__BASE__HPP_CPP__VOID_RETURN_VALUE \
	QLOGICAE_COR_V1__BASE__HPP_CPP__EMPTY_MACROS \

#define QLOGICAE_COR_V1__BASE__HPP_CPP__EMPTY_NAMESPACE_CODE \
	QLOGICAE_COR_V1__BASE__HPP_CPP__EMPTY_MACROS \

#define QLOGICAE_COR_V1__BASE__HPP_CPP__TRY_CATCH_EXCEPTION_NAME \
	exception \

#define QLOGICAE_COR_V1__BASE__HPP_CPP__EMPTY_TRY_CODE \
	QLOGICAE_COR_V1__BASE__HPP_CPP__EMPTY_MACROS \

#define QLOGICAE_COR_V1__BASE__HPP_CPP__EMPTY_CATCH_CODE \
	QLOGICAE_COR_V1__BASE__HPP_CPP__EMPTY_MACROS \

#define QLOGICAE_COR_V1__BASE__HPP_CPP__TRY_CATCH_EXCEPTION_PARAMETER \
	const std::exception& QLOGICAE_COR_V1__BASE__HPP_CPP__TRY_CATCH_EXCEPTION_NAME \
...
#define QLOGICAE_COR_V1__BASE__HPP_CPP__CONCATENATE_IMPLEMENTATION(value_1, value_2) \
	value_1##value_2 \

#define QLOGICAE_COR_V1__BASE__HPP_CPP__CONCATENATE(value_1, value_2) \
	QLOGICAE_COR_V1__BASE__HPP_CPP__CONCATENATE_IMPLEMENTATION(value_1, value_2) \



#define QLOGICAE_COR_V1__BASE__HPP__MUTEX_LAYER_TEMPLATE(mutex_layer_number) \
	QLOGICAE_COR_V1__BASE__HPP_CPP__CONCATENATE(feature_handling_mutex_, mutex_layer_number); \
...
#define QLOGICAE_COR_V1__BASE__HPP_CPP__EDGE_CASE_GUARD_TEMPLATE(return_value, ...) \
    if ( \
		configurations \
...
#define QLOGICAE_COR_V1__IMPLICIT__HPP_CPP__EDGE_CASE_GUARD_TEMPLATE(...) \
    QLOGICAE_COR_V1__BASE__HPP_CPP__EDGE_CASE_GUARD_TEMPLATE \
	( \
...
#define QLOGICAE_COR_V1__EXPLICIT__HPP_CPP__EDGE_CASE_GUARD_TEMPLATE(return_value, ...) \
    QLOGICAE_COR_V1__BASE__HPP_CPP__EDGE_CASE_GUARD_TEMPLATE \
	( \
		return_value, \
		__VA_ARGS__ \
...
#define QLOGICAE_COR_V1__BASE__HPP_CPP__MUTEX_LAYER_1_TEMPLATE() \
    QLOGICAE_COR_V1__BASE__HPP_CPP__THREAD_SAFETY_GUARD_TEMPLATE \
	( \
		QLOGICAE_COR_V1__BASE__HPP_CPP__MUTEX_LAYER_1 \
	); \

#define QLOGICAE_COR_V1__BASE__HPP_CPP__MUTEX_LAYER_2_TEMPLATE() \
    QLOGICAE_COR_V1__BASE__HPP_CPP__THREAD_SAFETY_GUARD_TEMPLATE \
	( \
		QLOGICAE_COR_V1__BASE__HPP_CPP__MUTEX_LAYER_2 \
	); \

#define QLOGICAE_COR_V1__BASE__HPP_CPP__MUTEX_LAYER_3_TEMPLATE() \
    QLOGICAE_COR_V1__BASE__HPP_CPP__THREAD_SAFETY_GUARD_TEMPLATE \
	( \
		QLOGICAE_COR_V1__BASE__HPP_CPP__MUTEX_LAYER_3 \
	); \

#define QLOGICAE_COR_V1__BASE__HPP_CPP__MUTEX_LAYER_4_TEMPLATE() \
    QLOGICAE_COR_V1__BASE__HPP_CPP__THREAD_SAFETY_GUARD_TEMPLATE \
	( \
		QLOGICAE_COR_V1__BASE__HPP_CPP__MUTEX_LAYER_4 \
	); \
...
#define QLOGICAE_COR_V1__IMPLICIT__HPP_CPP__CATCH_CODE_TEMPLATE() \
    QLOGICAE_COR_V1__BASE__HPP_CPP__CATCH_CODE_TEMPLATE \
	( \
		QLOGICAE_COR_V1__BASE__HPP_CPP__IMPLICIT_RETURN_VALUE \
	); \
