...
{            
    ...
    bool
        Results<void>::is_status_warning()
    {
    ...
    bool
        Results<void>::is_status_exception()
    {
    ...
    void
        Results<void>::set_status_to_good()
    {
        set_status(ResultsStatus::GOOD);
    }

    void
        Results<void>::set_status_to_bad()
    {
        set_status(ResultsStatus::BAD);
    }

    void
        Results<void>::set_status_to_info()
    {
        set_status(ResultsStatus::INFO);
    }

    void
        Results<void>::set_status_to_debug()
    {
        set_status(ResultsStatus::DEBUG);
    }

    void
        Results<void>::set_status_to_warning()
    {
        set_status(ResultsStatus::WARNING);
    }

    void
        Results<void>::set_status_to_exception()
    {
    ...
    void
        Results<void>::set_to_status_without_value(
            const ResultsStatus&
                status
        )
    {
    ...
    void
        Results<void>::set_to_good_status_without_value()
    {
        set_status_to_good();
    }
    ...
    void
        Results<void>::set_to_bad_status_without_value()
    {
        set_status_to_bad();
    }
