...
from library import file_logger, filesystem, logger, macros, system, value_cache
...
class Handler:
    def handle_setup(self):
        value_cache.singleton.set_one_value(
            ...
            filesystem.singleton.get_root_workspace_folder(),
        ...
        system.singleton.change_cli_filesystem_path(
            value_cache.singleton.get_one_value(
                ["root-current-full-path"],
                target_cache_value=TargetCacheValue.FOLDER_PATH,
            )
            ...
            for configuration_file in Path(
                ...
                with open(
                    ...
                    value_cache.singleton.set_one_value(
                        ...
                        ({} if "metadata" not in raw else raw["metadata"])
                        or {},
                        target_cache_value=TargetCacheValue.ANY,
                    )
                    value_cache.singleton.set_one_value(
