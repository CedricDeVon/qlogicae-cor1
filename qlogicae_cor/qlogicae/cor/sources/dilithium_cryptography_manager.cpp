	...
	QLOGICAE_COR_V1__BASE__HPP_CPP__COR_NAMESPACE_NAME
{
    DilithiumCryptographyManager
		::DilithiumCryptographyManager() :
			QLOGICAE_COR_V1__BASE__HPP_CPP__ABSTRACT_CLASS_NAME<DilithiumCryptographyManagerConfigurations>()
	{
			...
			)
	{
        ...
        {					
			...
			OQS_SIG* sig = OQS_SIG_new(
				QLOGICAE_COR_V1__BASE__HPP_CPP__GET_SINGLETON_TEMPLATE<DilithiumCryptographyAlgorithmEnumManager>()
